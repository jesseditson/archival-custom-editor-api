declare module "archival-editor-api" {
  ...
  export type InjectedAPI<T extends keyof FieldValueType> = Omit<
    ArchivalEditorAPI<T>,
    "send" | "listen"
  >;
  ...
  export type ArchivalEditorReadyListener<T extends keyof FieldValueType> = (
    api: ArchivalEditorAPI<T>
  ) => Promise<ArchivalEditorConfig> | ArchivalEditorConfig;
